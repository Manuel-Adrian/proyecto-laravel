...
@section('titulo','Agregando Alumno') 
<!------------------------------------------------------------------------------------------------------>
@section('content')
    <h3 class="text-success">Agregar Estudiante</h3> <br> 
    <form action="{{ route('insertarEstudiante') }}" method="POST" id="formulario">
        @csrf
        ...
        <input type="reset" value="Limpiar Consola" class="btn btn-outline-warning btn-lg">
    </form>
