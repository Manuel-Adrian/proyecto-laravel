        ...
        <div class="container-fluid"> 
            <div class="row" >
                <div class="col-sm-4">
                    <input type="text" class="form-control text-uppercase" 
                        ...
                        name="nombre" value="{{ old('nombre',$estudiante->nombre )}}" 
                        title="Ingresa tu(s) nombres(s)" required 
                        pattern="[A-Za-z,ñ,ü,á,é,í,ó,ú,Á,É,Í,Ó,Ú ]+" minlength="3" 
                        maxlength="100"
                    >
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control text-uppercase" 
                    ...
                    name="apellido_paterno" value="{{ old('apellido_paterno',$estudiante->apellido_paterno) }}" 
        ...
        <div class="row">
            <div class="col-sm-1">
                <input type="number" class="form-control" 
                    ...
                    name="edad" value="{{ old('edad',$estudiante->edad) }}" 
                    required min="17" 
                    max="120"
                >
            ...
            <div class="col-sm-5">
                <input type="email" class="form-control text-lowercase" 
                    ...
                    name="email" value="{{ old('email',$estudiante->email) }}" 
                    required minlength="8" 
                    maxlength="150" pattern="[A-Za-z_-0-9]+ @ [A-za-z._-0-9]+[.]$[A-za-z]{2,5}"
                >
